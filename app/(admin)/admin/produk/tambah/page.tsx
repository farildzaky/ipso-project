    ...
    <div>
      <div className="mb-6">
        <p className="text-sm text-gray-400">
          Menu /{" "}
          <Link href="/admin/produk" className="text-gray-600 hover:underline">
            Product
          </Link>
        </p>
      ...
      >
        ...
        {/* Fields */}
        {[
          { name: "namaProduct", label: "Nama Produk", placeholder: "Contoh: Salad Buah", type: "text" },
          { name: "harga", label: "Harga Jual", placeholder: "20000", type: "number" },
          { name: "stok", label: "Stok", placeholder: "0", type: "number" },
        ].map((f) => (
          <div key={f.name}>
        ...
        <div>
          ...
          <textarea
            name="deskripsi"
            id="deskripsi"
            placeholder="Jelaskan detail kondisi makanan"
            rows={3}
            required
        ...
        <div>
          ...
          <input
            ...
            id="tenant"
            type="text"
            placeholder="Contoh: EcoBite Store"
            required
            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-200"
          />
        </div>
